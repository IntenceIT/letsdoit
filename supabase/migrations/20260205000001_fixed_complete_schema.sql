-- =====================================================
-- FIXED COMPLETE TASK MANAGEMENT SYSTEM SCHEMA
-- Handles existing triggers and tables properly
-- =====================================================
...
-- =====================================================
-- AUTO-CREATE MEMBER ON USER SIGN-UP
-- =====================================================
...
CREATE OR REPLACE FUNCTION public.cleanup_old_assignments()
RETURNS void AS $$
BEGIN
